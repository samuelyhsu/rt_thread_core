...
enum ioremap_type { MM_AREA_TYPE_PHY, MM_AREA_TYPE_PHY_CACHED };
...
#else
void *rt_ioremap(void *paddr, size_t size) { return paddr; }

void *rt_ioremap_nocache(void *paddr, size_t size) { return paddr; }

void *rt_ioremap_cached(void *paddr, size_t size) { return paddr; }
