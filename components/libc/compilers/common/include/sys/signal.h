...
#define SI_TIMER                                                               \
  0x03 /* Signal generated by expiration of a timer set by timer_settime(). */
#define SI_ASYNCIO                                                             \
  0x04 /* Signal generated by completion of an asynchronous I/O request. */
#define SI_MESGQ                                                               \
  0x05 /* Signal generated by arrival of a message on an empty message queue.  \
        */
