...
/* extension */
#define O_ACCMODE                                                                        \
  0x0003 /* mask for above modes, from 4.4BSD                                            \
            https://minnie.tuhs.org/cgi-bin/utree.pl?file=4.4BSD/usr/include/sys/fcntl.h \
          */
#define O_NONBLOCK                                                                                   \
  0x0004                     /* non blocking I/O, from BSD apple                                     \
                                https://opensource.apple.com/source/xnu/xnu-1228.0.2/bsd/sys/fcntl.h \
                              */
