...
#define MSD_USE_PRE_ERASED /**< id define MSD_USE_PRE_ERASED, before CMD25,    \
                              send ACMD23 */
...
extern rt_err_t msd_init(const char *sd_device_name,
