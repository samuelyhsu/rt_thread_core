...
static rt_ssize_t _spi_bus_device_read(rt_device_t dev, rt_off_t pos,
...
static rt_ssize_t _spi_bus_device_write(rt_device_t dev, rt_off_t pos,
...
const static struct rt_device_ops spi_bus_ops = {
    RT_NULL, RT_NULL, RT_NULL, _spi_bus_device_read, _spi_bus_device_write,
    RT_NULL};
#endif
...
static rt_ssize_t _spidev_device_read(rt_device_t dev, rt_off_t pos,
                                      void *buffer, rt_size_t size) {
...
static rt_ssize_t _spidev_device_write(rt_device_t dev, rt_off_t pos,
                                       const void *buffer, rt_size_t size) {
  struct rt_spi_device *device;
...
#ifdef RT_USING_DEVICE_OPS
const static struct rt_device_ops spi_device_ops = {RT_NULL,
                                                    RT_NULL,
                                                    RT_NULL,
                                                    _spidev_device_read,
