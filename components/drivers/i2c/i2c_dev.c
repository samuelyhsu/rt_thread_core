...
static rt_ssize_t i2c_bus_device_read(rt_device_t dev, rt_off_t pos,
...
static rt_ssize_t i2c_bus_device_write(rt_device_t dev, rt_off_t pos,
  ...
  return rt_i2c_master_send(bus, addr, flags, (const rt_uint8_t *)buffer,
                            count);
}
...
const static struct rt_device_ops i2c_ops = {RT_NULL,
                                             RT_NULL,
                                             RT_NULL,
                                             i2c_bus_device_read,
