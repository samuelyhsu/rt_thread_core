...
struct hwcrypto_symmetric_ops {
  rt_err_t (*crypt)(struct hwcrypto_symmetric *symmetric_ctx,
                    struct hwcrypto_symmetric_info
                        *symmetric_info); /**< Hardware Symmetric Encryption and
                                             Decryption Callback */
};

/**
 * @brief           Hardware driver usage, including input and output
 * information
 */
struct hwcrypto_symmetric_info {
  hwcrypto_mode
      mode; /**< crypto mode. HWCRYPTO_MODE_ENCRYPT or HWCRYPTO_MODE_DECRYPT */
  const rt_uint8_t *in; /**< Input data */
  rt_uint8_t *out;      /**< Output data will be written */
  rt_size_t length; /**< The length of the input data in Bytes. It's a multiple
                       of block size. */
};
...
struct hwcrypto_symmetric {
  ...
  rt_uint16_t flags;  /**< key or iv or ivoff has been changed. The flag will be
                         set up */
  ...
  const struct hwcrypto_symmetric_ops
 ...
 */
struct rt_hwcrypto_ctx *
rt_hwcrypto_symmetric_create(struct rt_hwcrypto_device *device,
                             hwcrypto_type type);
 ...
 */
rt_err_t rt_hwcrypto_symmetric_crypt(struct rt_hwcrypto_ctx *ctx,
                                     hwcrypto_mode mode, rt_size_t length,
                                     const rt_uint8_t *in, rt_uint8_t *out);
 ...
 * @return          RT_EOK on success.
 */
rt_err_t rt_hwcrypto_symmetric_setkey(struct rt_hwcrypto_ctx *ctx,
 ...
 */
int rt_hwcrypto_symmetric_getkey(struct rt_hwcrypto_ctx *ctx, rt_uint8_t *key,
                                 rt_uint32_t bitlen);
 ...
 * @return          RT_EOK on success.
 */
rt_err_t rt_hwcrypto_symmetric_setiv(struct rt_hwcrypto_ctx *ctx,
 ...
 */
int rt_hwcrypto_symmetric_getiv(struct rt_hwcrypto_ctx *ctx, rt_uint8_t *iv,
                                rt_size_t len);
 ...
 */
void rt_hwcrypto_symmetric_set_ivoff(struct rt_hwcrypto_ctx *ctx,
                                     rt_int32_t iv_off);
 ...
 */
void rt_hwcrypto_symmetric_get_ivoff(struct rt_hwcrypto_ctx *ctx,
                                     rt_int32_t *iv_off);
 ...
 * @return          RT_EOK on success.
 */
rt_err_t rt_hwcrypto_symmetric_cpy(struct rt_hwcrypto_ctx *des,
 ...
 * @return          RT_EOK on success.
 */
rt_err_t rt_hwcrypto_symmetric_set_type(struct rt_hwcrypto_ctx *ctx,
                                        hwcrypto_type type);
