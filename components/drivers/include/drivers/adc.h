...
struct rt_adc_ops {
  rt_err_t (*enabled)(struct rt_adc_device *device, rt_uint32_t channel,
                      rt_bool_t enabled);
  rt_err_t (*convert)(struct rt_adc_device *device, rt_uint32_t channel,
                      rt_uint32_t *value);
...
rt_err_t rt_hw_adc_register(rt_adc_device_t adc, const char *name,
                            const struct rt_adc_ops *ops,
