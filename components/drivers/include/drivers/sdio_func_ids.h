...
#define SDIO_FUNC_CODE_BT_A                                                    \
  0x02 /* SDIO Type-A for Bluetooth standard interface */
#define SDIO_FUNC_CODE_BT_B                                                    \
  0x03 /* SDIO Type-B for Bluetooth standard interface */
