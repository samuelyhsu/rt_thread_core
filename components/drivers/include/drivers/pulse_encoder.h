...
#define PULSE_ENCODER_CMD_GET_TYPE                                             \
  (128 + 0) /* get a pulse_encoder type information */
#define PULSE_ENCODER_CMD_ENABLE (128 + 1)  /* enable pulse_encoder */
#define PULSE_ENCODER_CMD_DISABLE (128 + 2) /* disable pulse_encoder */
#define PULSE_ENCODER_CMD_CLEAR_COUNT                                          \
  (128 + 3) /* clear pulse_encoder count                                       \
             */
...
struct rt_pulse_encoder_ops {
  ...
  rt_err_t (*control)(struct rt_pulse_encoder_device *pulse_encoder,
