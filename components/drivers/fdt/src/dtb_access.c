...
static void *dtb_node_find_property_value_of_size(const struct dtb_node *dn,
  ...
  struct dtb_property *prop =
      dtb_node_get_dtb_node_property(dn, propname, NULL);
...
void *dtb_node_get_dtb_node_property_value(const struct dtb_node *dtb_node,
  ...
  struct dtb_property *dtb_property =
      dtb_node_get_dtb_node_property(dtb_node, property_name, NULL);
...
int dtb_node_property_match_string(const struct dtb_node *dn,
  ...
  const struct dtb_property *prop =
      dtb_node_get_dtb_node_property(dn, propname, NULL);
  size_t l;
  int i;
  const char *p, *end;
...
/**
 * of_property_read_string_helper() - Utility helper for parsing string
 * properties
 * @np:     device node from which the property value is to be read.
 * @propname:   name of the property to be searched.
...
static int __dtb_node_parse_phandle_with_args(
    const struct dtb_node *dn, const char *list_name, const char *cells_name,
    int cell_count, int index, struct fdt_phandle_args *out_args) {
...
int dtb_node_parse_phandle_with_args(const struct dtb_node *dn,
  ...
  return __dtb_node_parse_phandle_with_args(dn, list_name, cells_name, 0, index,
                                            out_args);
}
...
int dtb_node_count_phandle_with_args(const struct dtb_node *dn,
  ...
  return __dtb_node_parse_phandle_with_args(dn, list_name, cells_name, 0, -1,
                                            NULL);
}
