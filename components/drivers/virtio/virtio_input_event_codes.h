...
#define KEY_BRIGHTNESS_AUTO                                                    \
  244 /* Set Auto Brightness: manual brightness control is off, rely on        \
         ambient */
...
#define KEY_NUMERIC_0                                                          \
  0x200 /* Used by phones, remote controls, and other keypads */
...
#define SW_RFKILL_ALL                                                          \
  0x03 /* rfkill master switch, type "any" set = radio enabled */
