...
#define VIRTIO_INPUT_QUEUE_MAX_SIZE                                            \
...
struct virtio_input_absinfo {
  ...
  rt_uint32_t
      fuzz; /* Fuzz value that is used to filter noise from the event stream */
  rt_uint32_t flat; /* Within this value will be discarded by joydev interface
