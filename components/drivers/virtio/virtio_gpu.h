...
#define VIRTIO_GPU_F_CONTEXT_INIT                                              \
  4 /* VIRTIO_GPU_CMD_CREATE_CONTEXT with context_init and multiple timelines  \
     */
...
#define VIRTIO_GPU_CURSOR_IMG_SIZE                                             \
  (VIRTIO_GPU_CURSOR_WIDTH * VIRTIO_GPU_CURSOR_HEIGHT * VIRTIO_GPU_FORMAT_PIXEL)
