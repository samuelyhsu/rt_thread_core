...
static rt_ssize_t random_read(rt_device_t dev, rt_off_t pos, void *buffer,
                              rt_size_t size) {
...
static rt_ssize_t random_write(rt_device_t dev, rt_off_t pos,
...
const static struct rt_device_ops random_ops = {
    RT_NULL, RT_NULL, RT_NULL, random_read, random_write, random_control};
#endif
...
static rt_ssize_t random_uread(rt_device_t dev, rt_off_t pos, void *buffer,
                               rt_size_t size) {
...
static rt_ssize_t random_uwrite(rt_device_t dev, rt_off_t pos,
                                const void *buffer, rt_size_t size) {
...
const static struct rt_device_ops urandom_ops = {
    RT_NULL, RT_NULL, RT_NULL, random_uread, random_uwrite, random_ucontrol};
#endif
