...
static int pts_register(struct tty_struct *ptm_drv, struct tty_struct *pts_drv,
                        int pts_index);
...
static rt_ssize_t pty_device_read(struct rt_device *dev, rt_off_t pos,
...
static rt_ssize_t pty_device_write(struct rt_device *dev, rt_off_t pos,
...
const static struct rt_device_ops pty_device_ops = {
    pty_device_init, pty_device_open,  pty_device_close,
    pty_device_read, pty_device_write, pty_device_control,
};
