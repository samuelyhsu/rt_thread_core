...
static rt_ssize_t phy_device_read(rt_device_t dev, rt_off_t pos, void *buffer,
                                  rt_size_t count) {
...
static rt_ssize_t phy_device_write(rt_device_t dev, rt_off_t pos,
...
const static struct rt_device_ops phy_ops = {
    RT_NULL, RT_NULL, RT_NULL, phy_device_read, phy_device_write, RT_NULL,
};
#endif
