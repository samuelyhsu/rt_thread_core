...
#define HID_ReportSizeL(x)                                                     \
  0x77, (x & 0xFF), ((x >> 8) & 0xFF), ((x >> 16) & 0xFF), ((x >> 24) & 0xFF)
#define HID_ReportID(x) 0x85, x
#define HID_ReportCount(x) 0x95, x
#define HID_ReportCountS(x) 0x96, (x & 0xFF), ((x >> 8) & 0xFF)
#define HID_ReportCountL(x)                                                    \
  0x97, (x & 0xFF), ((x >> 8) & 0xFF), ((x >> 16) & 0xFF), ((x >> 24) & 0xFF)
