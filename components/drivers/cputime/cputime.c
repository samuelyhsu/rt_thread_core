...
/**
 * The clock_cpu_settimeout() fucntion set timeout time and timeout callback
 * function The timeout callback function will be called when the timeout time
 * is reached
 *
 ...
 *
 */
int clock_cpu_settimeout(uint64_t tick, void (*timeout)(void *param),
                         void *param) {
  if (_cputime_ops)
