...
static u8_t dhcp_offer[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, /* MAC addr + padding */
...
static u8_t dhcp_ack[] = {
    ...
    0x00, 0x00, 0x00, 0x00,                         /* Relay agent */
    0x00, 0x23, 0xc1, 0xde, 0xd0, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, /* Macaddr + padding */
...
static void dhcp_setup(void) { txpacket = 0; }
...
static void check_pkt(struct pbuf *p, u32_t pos, const u8_t *mem, u32_t len) {
  ...
  data = (u8_t *)p->payload;
  fail_if(memcmp(&data[pos], mem, len),
          "data at pos %d, len %d in packet %d did not match", pos, len,
          txpacket);
}

static void check_pkt_fuzzy(struct pbuf *p, u32_t startpos, const u8_t *mem,
                            u32_t len) {
  int found;
  u32_t i;
  u8_t *data;
...
static err_t lwip_tx_func(struct netif *netif, struct pbuf *p) {
  ...
  case TEST_LWIP_DHCP:
    ...
    case 2: {
      ...
      if (txpacket == 1) {
        ...
        u8_t requested_ipaddr[] = {0x32, 0x04, 0xc3,
                                   0xaa, 0xbd, 0xc8}; /* Ask for offered IP */
  ...
  case TEST_LWIP_DHCP_NAK: {
    const u8_t ipproto[] = {0x08, 0x00};
    const u8_t bootp_start[] = {
        0x01, 0x01, 0x06, 0x00}; /* bootp request, eth, hwaddr len 6, 0 hops */
    const u8_t ipaddrs[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    const u8_t dhcp_nak_opt[] = {0x35, 0x01, 0x04};
    const u8_t requested_ipaddr[] = {0x32, 0x04, 0xc3,
                                     0xaa, 0xbd, 0xc8}; /* offered IP */
    ...
    check_pkt_fuzzy(p, 282, dhcp_nak_opt,
                    sizeof(dhcp_nak_opt)); /* NAK the ack */
  ...
  case TEST_LWIP_DHCP_RELAY:
    ...
    case 2: {
      ...
      if (txpacket == 1) {
        ...
        u8_t dhcp_request_opt[] = {0x35, 0x01, 0x03};
        u8_t requested_ipaddr[] = {0x32, 0x04, 0x4f,
                                   0x8a, 0x33, 0x05}; /* Ask for offered IP */
...
START_TEST(test_dhcp) {
  ...
  fail_unless(txpacket == 1, "TX %d packets, expected 1",
              txpacket); /* Nothing more sent */
  xid = htonl(netif_dhcp_data(&net_test)->xid);
  memcpy(&dhcp_offer[46], &xid, 4); /* insert correct transaction id */
  send_pkt(&net_test, dhcp_offer, sizeof(dhcp_offer));

  fail_unless(txpacket == 2, "TX %d packets, expected 2",
              txpacket);                 /* DHCP request sent */
  xid = netif_dhcp_data(&net_test)->xid; /* Write bad xid, not using htonl! */
  memcpy(&dhcp_ack[46], &xid, 4);
  send_pkt(&net_test, dhcp_ack, sizeof(dhcp_ack));

  fail_unless(txpacket == 2, "TX %d packets, still expected 2",
              txpacket);                        /* No more sent */
  ...
  fail_unless(txpacket == 5, "TX %d packets, expected 5",
              txpacket); /* ARP requests sent */
...
START_TEST(test_dhcp_relayed) {
  u8_t relay_offer[] = {
      ,
      ...
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x63, 0x82, 0x53, 0x63, 0x01, 0x04, 0xff, 0xff, 0xfe, 0x00,
      0x03, 0x04, 0x4f, 0x8a, 0x32, 0x01, 0x06, 0x08, 0x4f, 0x8a, 0x00, 0xb4,
      0x55, 0x08, 0x1f, 0xd1, 0x1c, 0x04, 0x4f, 0x8a, 0x33, 0xff, 0x33, 0x04,
      0x00, 0x00, 0x54, 0x49, 0x35, 0x01, 0x02, 0x36, 0x04, 0x0a, 0xb5, 0x04,
      0x01, 0xff};

  u8_t relay_ack1[] = {
      0x00, 0x23, 0xc1, 0xde, 0xd0, 0x0d, 0x00, 0x22, 0x93, 0x5a, 0xf7, 0x60,
      0x08, 0x00, 0x45, 0x00, 0x01, 0x38, 0xfd, 0x55, 0x00, 0x00, 0x40, 0x11,
      0x78, 0x44, 0x4f, 0x8a, 0x32, 0x02, 0x4f, 0x8a, 0x33, 0x05, 0x00, 0x43,
      0x00, 0x44, 0x01, 0x24, 0x00, 0x00, 0x02, 0x01, 0x06, 0x00, 0x51, 0x35,
      0xb6, 0xa1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4f, 0x8a,
      0x33, 0x05, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xb5, 0x04, 0x01, 0x00, 0x23,
      0xc1, 0xde, 0xd0, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      ...
      0x03, 0x04, 0x4f, 0x8a, 0x32, 0x01, 0x06, 0x08, 0x4f, 0x8a, 0x00, 0xb4,
      0x55, 0x08, 0x1f, 0xd1, 0x1c, 0x04, 0x4f, 0x8a, 0x33, 0xff, 0x33, 0x04,
      0x00, 0x00, 0x54, 0x49, 0x35, 0x01, 0x05, 0x36, 0x04, 0x0a, 0xb5, 0x04,
      0x01, 0xff};

  u8_t relay_ack2[] = {
      0x00, 0x23, 0xc1, 0xde, 0xd0, 0x0d, 0x00, 0x22, 0x93, 0x5a, 0xf7, 0x60,
      0x08, 0x00, 0x45, 0x00, 0x01, 0x38, 0xfa, 0x18, 0x00, 0x00, 0x40, 0x11,
      0x7b, 0x81, 0x4f, 0x8a, 0x32, 0x02, 0x4f, 0x8a, 0x33, 0x05, 0x00, 0x43,
      0x00, 0x44, 0x01, 0x24, 0x00, 0x00, 0x02, 0x01, 0x06, 0x00, 0x49, 0x8b,
      0x6e, 0xab, 0x00, 0x00, 0x00, 0x00, 0x4f, 0x8a, 0x33, 0x05, 0x4f, 0x8a,
      0x33, 0x05, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xb5, 0x04, 0x01, 0x00, 0x23,
      0xc1, 0xde, 0xd0, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      ...
      0x03, 0x04, 0x4f, 0x8a, 0x32, 0x01, 0x06, 0x08, 0x4f, 0x8a, 0x00, 0xb4,
      0x55, 0x08, 0x1f, 0xd1, 0x1c, 0x04, 0x4f, 0x8a, 0x33, 0xff, 0x33, 0x04,
      0x00, 0x00, 0x54, 0x60, 0x35, 0x01, 0x05, 0x36, 0x04, 0x0a, 0xb5, 0x04,
      0x01, 0xff};
  ...
  fail_unless(txpacket == 5, "txpkt should be 5, is %d",
              txpacket); /* ARP requests sent */
...
START_TEST(test_dhcp_nak_no_endmarker) {
  ...
  u8_t dhcp_nack_no_endmarker[] = {
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x54, 0x75, 0xd0, 0x26, 0xd0, 0x0d,
      0x08, 0x00, 0x45, 0x00, 0x01, 0x15, 0x38, 0x86, 0x00, 0x00, 0xff, 0x11,
      0xc0, 0xa8, 0xc0, 0xa8, 0x01, 0x01, 0xff, 0xff, 0xff, 0xff, 0x00, 0x43,
      0x00, 0x44, 0x01, 0x01, 0x00, 0x00, 0x02, 0x01, 0x06, 0x00, 0x7a, 0xcb,
      0xba, 0xf2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      ...
      };
  u32_t xid;
  LWIP_UNUSED_ARG(_i);
...
START_TEST(test_dhcp_invalid_overload) {
  ...
  fail_unless(txpacket == 1); /* DHCP discover sent */
  xid = htonl(netif_dhcp_data(&net_test)->xid);
  memcpy(&dhcp_offer_invalid_overload[46], &xid,
         4); /* insert correct transaction id */
...
Suite *dhcp_suite(void) {
  testfunc tests[] = {TESTFUNC(test_dhcp), TESTFUNC(test_dhcp_nak),
