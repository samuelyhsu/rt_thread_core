...
#error                                                                         \
    "The lwIP version is not support IPV6, please disable netdev IPV6 configuration "
#elif (LWIP_VERSION > 0x2000000) && (NETDEV_IPV6 != LWIP_IPV6)
#error                                                                         \
    "IPV6 configuration error, Please check and synchronize netdev and lwip IPV6 configuration."
#endif
...
static int inet_getsockname(int socket, struct sockaddr *name,
                            socklen_t *namelen) {
...
static const struct sal_socket_ops lwip_socket_ops = {
    ...
    (int (*)(int, const void *, size_t, int, const struct sockaddr *,
             socklen_t))lwip_sendto,
    (int (*)(int, void *, size_t, int, struct sockaddr *,
             socklen_t *))lwip_recvfrom,
    lwip_getsockopt,
    // TODO fix on 1.4.1
    lwip_setsockopt,
    lwip_shutdown,
