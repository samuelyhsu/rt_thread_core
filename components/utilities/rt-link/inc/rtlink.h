...
#define RT_LINK_MAX_DATA_LENGTH                                                \
  (RT_LINK_MAX_FRAME_LENGTH - RT_LINK_HEAD_LENGTH - RT_LINK_EXTEND_LENGTH -    \
   RT_LINK_CRC_LENGTH)
#define RT_LINK_RECEIVE_BUFFER_LENGTH                                          \
  (RT_LINK_MAX_FRAME_LENGTH * RT_LINK_FRAMES_MAX + RT_LINK_HEAD_LENGTH +       \
...
struct rt_link_session {
  ...
  rt_uint32_t (*calculate_crc)(rt_uint8_t using_buffer_ring, rt_uint8_t *data,
                               rt_size_t size);
