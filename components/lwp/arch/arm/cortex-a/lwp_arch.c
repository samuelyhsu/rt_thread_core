...
int arch_user_space_init(struct rt_lwp *lwp) {
  ...
  rt_memcpy(mmu_table + KPTE_START,
            (size_t *)rt_kernel_space.page_table + KPTE_START, ARCH_PAGE_SIZE);
...
void arch_kuser_init(rt_aspace_t aspace, void *vectors) {
  ...
  rt_memcpy((void *)((char *)vectors + 0x1000 - kuser_sz), __kuser_helper_start,
            kuser_sz);
  /*
  ...
  rt_hw_cpu_dcache_ops(RT_HW_CACHE_FLUSH,
                       (void *)((char *)vectors + 0x1000 - kuser_sz), kuser_sz);
