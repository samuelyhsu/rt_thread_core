...
struct CLIENT {
  ...
  struct clnt_ops {
    enum clnt_stat (*cl_call)(CLIENT *, unsigned long, xdrproc_t, char *,
 ...
 *  unsigned int recvsz;
 */
extern CLIENT *clntudp_create(struct sockaddr_in *__raddr,
                              unsigned long __program, unsigned long __version,
                              struct timeval __wait_resend, int *__sockp);
extern CLIENT *clntudp_bufcreate(struct sockaddr_in *__raddr,
                                 unsigned long __program,
                                 unsigned long __version,
                                 struct timeval __wait_resend, int *__sockp,
