...
extern bool_t xdr_array(XDR *_xdrs, char **__addrp, unsigned int *__sizep,
                        unsigned int __maxsize, unsigned int __elsize,
                        xdrproc_t __elproc);
...
extern bool_t xdr_union(XDR *__xdrs, enum_t *__dscmp, char *__unp,
                        const struct xdr_discrim *__choices, xdrproc_t dfault);
...
extern bool_t xdr_reference(XDR *__xdrs, char **__xpp, unsigned int __size,
                            xdrproc_t __proc);
extern bool_t xdr_pointer(XDR *__xdrs, char **__objpp, unsigned int __obj_size,
                          xdrproc_t __xdr_obj);
...
extern void xdrmem_create(XDR *__xdrs, const char *__addr, unsigned int __size,
                          enum xdr_op __xop);
