...
struct dfs_filesystem_ops {
  ...
  int (*mount)(struct dfs_filesystem *fs, unsigned long rwflag,
               const void *data);
  ...
  int (*stat)(struct dfs_filesystem *fs, const char *filename,
              struct stat *buf);
  int (*rename)(struct dfs_filesystem *fs, const char *oldpath,
                const char *newpath);
};
