...
/* The name convention below is from previous LPC2000 family MCUs, in
LPC23xx/24xx, these registers are known as "VICVectPriority(x)". */
...
#define GPDMA_RAW_INT_TCSTAT                                                   \
  (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x014))
#define GPDMA_RAW_INT_ERR_STAT                                                 \
  (*(volatile unsigned long *)(DMA_BASE_ADDR + 0x018))
...
#define MAC_MAC1                                                               \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x000)) /* MAC config reg 1 */
#define MAC_MAC2                                                               \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x004)) /* MAC config reg 2 */
#define MAC_IPGT                                                               \
  (*(volatile unsigned long *)(MAC_BASE_ADDR +                                 \
...
#define MAC_MAXF                                                               \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x014)) /* MAXimum Frame reg */
#define MAC_SUPP                                                               \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x018)) /* PHY SUPPort reg */
#define MAC_TEST                                                               \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x01C)) /* TEST reg */
#define MAC_MCFG                                                               \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x020)) /* MII Mgmt ConFiG reg  \
                                                        */
#define MAC_MCMD                                                               \
  (*(volatile unsigned long *)(MAC_BASE_ADDR +                                 \
...
#define MAC_COMMAND                                                            \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x100)) /* Command reg */
#define MAC_STATUS                                                             \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x104)) /* Status reg (RO) */
...
#define MAC_RXFILTERCTRL                                                       \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0x200)) /* Rx filter ctrl reg   \
                                                        */
...
#define MAC_POWERDOWN                                                          \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0xFF4)) /* Power-down reg */
#define MAC_MODULEID                                                           \
  (*(volatile unsigned long *)(MAC_BASE_ADDR + 0xFFC)) /* Module ID reg (RO)   \
                                                        */
