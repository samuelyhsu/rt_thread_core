...
#define MMU_MAP_K_RO                                                           \
  (MMU_MAP_MTBL_NG(0)) |                                                       \
      (MMU_MAP_MTBL_A | MMU_MAP_MTBL_AP2(1) | MMU_MAP_MTBL_AP01(1) |           \
       MMU_MAP_MTBL_TEX(0) | MMU_MAP_MTBL_C | MMU_MAP_MTBL_SHARE)
#define MMU_MAP_K_RWCB                                                         \
  (MMU_MAP_MTBL_NG(0)) |                                                       \
      (MMU_MAP_MTBL_A | MMU_MAP_MTBL_AP2(0) | MMU_MAP_MTBL_AP01(1) |           \
       MMU_MAP_MTBL_TEX(0) | MMU_MAP_MTBL_B | MMU_MAP_MTBL_C |                 \
       MMU_MAP_MTBL_SHARE)
#define MMU_MAP_K_RW                                                           \
  (MMU_MAP_MTBL_NG(0)) |                                                       \
      (MMU_MAP_MTBL_A | MMU_MAP_MTBL_AP2(0) | MMU_MAP_MTBL_AP01(1) |           \
       MMU_MAP_MTBL_TEX(0) | MMU_MAP_MTBL_SHARE)
#define MMU_MAP_K_DEVICE                                                       \
  (MMU_MAP_MTBL_NG(0)) |                                                       \
      (MMU_MAP_MTBL_A | MMU_MAP_MTBL_AP2(0) | MMU_MAP_MTBL_AP01(1) |           \
       MMU_MAP_MTBL_TEX(0) | MMU_MAP_MTBL_B | MMU_MAP_MTBL_SHARE)
#define MMU_MAP_U_RO                                                           \
  (MMU_MAP_MTBL_NG(1)) |                                                       \
      (MMU_MAP_MTBL_A | MMU_MAP_MTBL_AP2(0) | MMU_MAP_MTBL_AP01(2) |           \
       MMU_MAP_MTBL_TEX(0) | MMU_MAP_MTBL_C | MMU_MAP_MTBL_SHARE)
#define MMU_MAP_U_RWCB                                                         \
  (MMU_MAP_MTBL_NG(1)) |                                                       \
      (MMU_MAP_MTBL_A | MMU_MAP_MTBL_AP2(0) | MMU_MAP_MTBL_AP01(3) |           \
       MMU_MAP_MTBL_TEX(0) | MMU_MAP_MTBL_B | MMU_MAP_MTBL_C |                 \
       MMU_MAP_MTBL_SHARE)
#define MMU_MAP_U_RW                                                           \
  (MMU_MAP_MTBL_NG(1)) |                                                       \
...
int rt_hw_mmu_ioremap_init(struct rt_aspace *aspace, void *v_address,
                           size_t size);
...
int rt_hw_mmu_map_init(struct rt_aspace *aspace, void *v_address, size_t size,
