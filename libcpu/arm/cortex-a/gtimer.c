...
/** Set CNTFRQ
 *  This function assigns the given value to PL1 Physical Timer Counter
 ...
 * Register (CNTFRQ). return CNTFRQ Register value
 */
 ...
 * (CNTP_TVAL). param value: CNTP_TVAL Register value to set
 */
 ...
 * (CNTP_TVAL). return CNTP_TVAL Register value
 */
 ...
 * (CNTPCT). return CNTPCT Register value
 */
 ...
 * CompareValue Register (CNTP_CVAL). param value: CNTP_CVAL Register value to
 * set
 */
 ...
 * CompareValue Register (CNTP_CVAL). return CNTP_CVAL Register value
 */
 ...
 * (CNTP_CTL). param value: CNTP_CTL Register value to set
 */
 ...
 */
rt_uint32_t gtimer_get_counter_frequency(void) { return (__get_cntfrq()); }
 ...
 */
rt_uint32_t gtimer_get_current_value(void) { return (__get_cntp_tval()); }

/** Get the current physical counter value.
 *  return Current physical counter value.
 */
rt_uint64_t gtimer_get_current_physical_value(void) { return (__get_cntpct()); }
 ...
 */
rt_uint32_t gtimer_get_control(void) { return (__get_cntp_ctl()); }
