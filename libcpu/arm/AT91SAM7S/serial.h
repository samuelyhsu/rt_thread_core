...
#define AT91C_US_CLKS_SLOW                                                     \
  ((unsigned int)0x2 << 4)                         /* USAR) slow_clock (ARM)   \
                                                    */
#define AT91C_US_CLKS_EXT ((unsigned int)0x3 << 4) /* USAR) External (SCK) */

#define AT91C_US_CHRL_5_BITS                                                   \
  ((unsigned int)0x0 << 6) /* USAR) Character Length: 5 bits */
#define AT91C_US_CHRL_6_BITS                                                   \
  ((unsigned int)0x1 << 6) /* USAR) Character Length: 6 bits */
#define AT91C_US_CHRL_7_BITS                                                   \
  ((unsigned int)0x2 << 6) /* USAR) Character Length: 7 bits */
#define AT91C_US_CHRL_8_BITS                                                   \
  ((unsigned int)0x3 << 6) /* USAR) Character Length: 8 bits */
