...
void mmu_setttbase(rt_uint32_t i) {
  ...
  value = 0x55555555;
  __asm volatile { mcr p15, 0, value, c3, c0, 0 mcr p15, 0, i, c2, c0, 0 }
}
...
void mmu_enable() {
  ...
  __asm volatile {
    mrc p15, 0, value, c1, c0, 0 orr value, value, #0x01 mcr p15, 0, value, c1,
        c0, 0
  }
}
...
void mmu_disable() {
  ...
  __asm volatile {
    mrc p15, 0, value, c1, c0, 0 bic value, value, #0x01 mcr p15, 0, value, c1,
        c0, 0
  }
}
...
void mmu_enable_icache() {
  ...
  __asm volatile {
    mrc p15, 0, value, c1, c0, 0 orr value, value, #0x1000 mcr p15, 0, value,
        c1, c0, 0
  }
}
...
void mmu_enable_dcache() {
  ...
  __asm volatile {
    mrc p15, 0, value, c1, c0, 0 orr value, value, #0x04 mcr p15, 0, value, c1,
        c0, 0
  }
}
...
void mmu_disable_icache() {
  ...
  __asm volatile {
    mrc p15, 0, value, c1, c0, 0 bic value, value, #0x1000 mcr p15, 0, value,
        c1, c0, 0
  }
}
...
void mmu_disable_dcache() {
  ...
  __asm volatile {
    mrc p15, 0, value, c1, c0, 0 bic value, value, #0x04 mcr p15, 0, value, c1,
        c0, 0
  }
}
...
void mmu_enable_alignfault() {
  ...
  __asm volatile {
    mrc p15, 0, value, c1, c0, 0 orr value, value, #0x02 mcr p15, 0, value, c1,
        c0, 0
  }
}
...
void mmu_disable_alignfault() {
  ...
  __asm volatile {
    mrc p15, 0, value, c1, c0, 0 bic value, value, #0x02 mcr p15, 0, value, c1,
        c0, 0
  }
}
...
void mmu_enable() {
  ...
  i |= 0x1;
  i |= (1 << 13); /* High exception vectors selected, address range =
  ...
  for (i = 0; i < total_page; i++) {
    ...
    if (*pTT == 0) /* Level 1 page table item not used, now update pgd item */
    {
      *pTT = pte_offset | sect_attr;
      p_pteentry = (rt_uint32_t *)pte_offset + ((vaddr & 0x000ff000) >> 12);
      pte_offset += 1024;
    } else /* using old Level 1 page table item */
    {
      p_pteentry =
          (rt_uint32_t *)(*pTT & 0xfffffc00) + ((vaddr & 0x000ff000) >> 12);
    }
