...
#define INTOFFSET                                                              \
  (*(volatile unsigned *)0x4a000014) // Interruot request source offset
...
#define DISRCC0                                                                \
  (*(volatile unsigned *)0x4b000004) // DMA 0 Initial source control
#define DIDST0 (*(volatile unsigned *)0x4b000008) // DMA 0 Initial Destination
#define DIDSTC0                                                                \
  (*(volatile unsigned *)0x4b00000c) // DMA 0 Initial Destination control
...
#define DISRCC1                                                                \
  (*(volatile unsigned *)0x4b000044) // DMA 1 Initial source control
#define DIDST1 (*(volatile unsigned *)0x4b000048) // DMA 1 Initial Destination
#define DIDSTC1                                                                \
  (*(volatile unsigned *)0x4b00004c) // DMA 1 Initial Destination control
...
#define DISRCC2                                                                \
  (*(volatile unsigned *)0x4b000084) // DMA 2 Initial source control
...
#define DISRCC3                                                                \
  (*(volatile unsigned *)0x4b0000c4) // DMA 3 Initial source control
#define DIDST3 (*(volatile unsigned *)0x4b0000c8) // DMA 3 Initial Destination
#define DIDSTC3                                                                \
  (*(volatile unsigned *)0x4b0000cc) // DMA 3 Initial Destination control
...
#define CAMDIVN                                                                \
  (*(volatile unsigned *)0x4c000018) // USB, CAM Clock divider control
...
#define LCDSADDR1                                                              \
  (*(volatile unsigned *)0x4d000014) // STN/TFT Frame buffer start address 1
#define LCDSADDR2                                                              \
  (*(volatile unsigned *)0x4d000018) // STN/TFT Frame buffer start address 2
#define LCDSADDR3                                                              \
  (*(volatile unsigned *)0x4d00001c) // STN/TFT Virtual screen address set
...
#ifdef __BIG_ENDIAN
#define UTXH0                                                                  \
  (*(volatile unsigned char *)0x50000023)             // UART 0 Transmission
                                                      // Hold
#define URXH0 (*(volatile unsigned char *)0x50000027) // UART 0 Receive buffer
#define UTXH1                                                                  \
  (*(volatile unsigned char *)0x50004023)             // UART 1 Transmission
                                                      // Hold
#define URXH1 (*(volatile unsigned char *)0x50004027) // UART 1 Receive buffer
#define UTXH2                                                                  \
  (*(volatile unsigned char *)0x50008023)             // UART 2 Transmission
                                                      // Hold
...
#else // Little Endian
#define UTXH0                                                                  \
  (*(volatile unsigned char *)0x50000020)             // UART 0 Transmission
                                                      // Hold
#define URXH0 (*(volatile unsigned char *)0x50000024) // UART 0 Receive buffer
#define UTXH1                                                                  \
  (*(volatile unsigned char *)0x50004020)             // UART 1 Transmission
                                                      // Hold
#define URXH1 (*(volatile unsigned char *)0x50004024) // UART 1 Receive buffer
#define UTXH2                                                                  \
  (*(volatile unsigned char *)0x50008020)             // UART 2 Transmission
                                                      // Hold
...
#define MSLCON                                                                 \
  (*(volatile unsigned *)0x560000cc) // Memory sleep control register

// USB DEVICE
#ifdef __BIG_ENDIAN
#define FUNC_ADDR_REG                                                          \
  (*(volatile unsigned char *)0x52000143)               // Function
                                                        // address
#define PWR_REG (*(volatile unsigned char *)0x52000147) // Power management
#define EP_INT_REG                                                             \
  (*(volatile unsigned char *)0x5200014b) // EP Interrupt pending and clear
#define USB_INT_REG                                                            \
  (*(volatile unsigned char *)0x5200015b) // USB Interrupt pending and clear
#define EP_INT_EN_REG                                                          \
  (*(volatile unsigned char *)0x5200015f) // Interrupt
                                          // enable
#define USB_INT_EN_REG (*(volatile unsigned char *)0x5200016f)
#define FRAME_NUM1_REG                                                         \
  (*(volatile unsigned char *)0x52000173) // Frame number lower byte
#define FRAME_NUM2_REG                                                         \
  (*(volatile unsigned char *)0x52000177) // Frame number higher byte
...
#define IN_CSR1_REG                                                            \
  (*(volatile unsigned char *)0x52000187) // In endpoint control status
#define IN_CSR2_REG (*(volatile unsigned char *)0x5200018b)
#define OUT_CSR1_REG                                                           \
  (*(volatile unsigned char *)0x52000193) // Out endpoint control status
#define OUT_CSR2_REG (*(volatile unsigned char *)0x52000197)
#define OUT_FIFO_CNT1_REG                                                      \
  (*(volatile unsigned char *)0x5200019b) // Endpoint out write count
...
#define EP1_DMA_CON                                                            \
  (*(volatile unsigned char *)0x52000203) // EP1 DMA interface control
#define EP1_DMA_UNIT                                                           \
  (*(volatile unsigned char *)0x52000207) // EP1 DMA Tx unit counter
#define EP1_DMA_FIFO                                                           \
  (*(volatile unsigned char *)0x5200020b) // EP1 DMA Tx FIFO counter
#define EP1_DMA_TTC_L                                                          \
  (*(volatile unsigned char *)0x5200020f) // EP1 DMA total Tx counter
#define EP1_DMA_TTC_M (*(volatile unsigned char *)0x52000213)
#define EP1_DMA_TTC_H (*(volatile unsigned char *)0x52000217)
#define EP2_DMA_CON                                                            \
  (*(volatile unsigned char *)0x5200021b) // EP2 DMA interface control
#define EP2_DMA_UNIT                                                           \
  (*(volatile unsigned char *)0x5200021f) // EP2 DMA Tx unit counter
#define EP2_DMA_FIFO                                                           \
  (*(volatile unsigned char *)0x52000223) // EP2 DMA Tx FIFO counter
#define EP2_DMA_TTC_L                                                          \
  (*(volatile unsigned char *)0x52000227) // EP2 DMA total Tx counter
#define EP2_DMA_TTC_M (*(volatile unsigned char *)0x5200022b)
#define EP2_DMA_TTC_H (*(volatile unsigned char *)0x5200022f)
#define EP3_DMA_CON                                                            \
  (*(volatile unsigned char *)0x52000243) // EP3 DMA interface control
#define EP3_DMA_UNIT                                                           \
  (*(volatile unsigned char *)0x52000247) // EP3 DMA Tx unit counter
#define EP3_DMA_FIFO                                                           \
  (*(volatile unsigned char *)0x5200024b) // EP3 DMA Tx FIFO counter
#define EP3_DMA_TTC_L                                                          \
  (*(volatile unsigned char *)0x5200024f) // EP3 DMA total Tx counter
#define EP3_DMA_TTC_M (*(volatile unsigned char *)0x52000253)
#define EP3_DMA_TTC_H (*(volatile unsigned char *)0x52000257)
#define EP4_DMA_CON                                                            \
  (*(volatile unsigned char *)0x5200025b) // EP4 DMA interface control
#define EP4_DMA_UNIT                                                           \
  (*(volatile unsigned char *)0x5200025f) // EP4 DMA Tx unit counter
#define EP4_DMA_FIFO                                                           \
  (*(volatile unsigned char *)0x52000263) // EP4 DMA Tx FIFO counter
#define EP4_DMA_TTC_L                                                          \
  (*(volatile unsigned char *)0x52000267) // EP4 DMA total Tx counter
#define EP4_DMA_TTC_M (*(volatile unsigned char *)0x5200026b)
#define EP4_DMA_TTC_H (*(volatile unsigned char *)0x5200026f)

#else // Little Endian
#define FUNC_ADDR_REG                                                          \
  (*(volatile unsigned char *)0x52000140)               // Function
                                                        // address
#define PWR_REG (*(volatile unsigned char *)0x52000144) // Power management
#define EP_INT_REG                                                             \
  (*(volatile unsigned char *)0x52000148) // EP Interrupt pending and clear
#define USB_INT_REG                                                            \
  (*(volatile unsigned char *)0x52000158) // USB Interrupt pending and clear
#define EP_INT_EN_REG                                                          \
  (*(volatile unsigned char *)0x5200015c) // Interrupt
                                          // enable
#define USB_INT_EN_REG (*(volatile unsigned char *)0x5200016c)
#define FRAME_NUM1_REG                                                         \
  (*(volatile unsigned char *)0x52000170) // Frame number lower byte
#define FRAME_NUM2_REG                                                         \
  (*(volatile unsigned char *)0x52000174) // Frame number higher byte
...
#define IN_CSR1_REG                                                            \
  (*(volatile unsigned char *)0x52000184) // In endpoint control status
#define IN_CSR2_REG (*(volatile unsigned char *)0x52000188)
#define OUT_CSR1_REG                                                           \
  (*(volatile unsigned char *)0x52000190) // Out endpoint control status
#define OUT_CSR2_REG (*(volatile unsigned char *)0x52000194)
#define OUT_FIFO_CNT1_REG                                                      \
  (*(volatile unsigned char *)0x52000198) // Endpoint out write count
...
#define EP1_DMA_CON                                                            \
  (*(volatile unsigned char *)0x52000200) // EP1 DMA interface control
#define EP1_DMA_UNIT                                                           \
  (*(volatile unsigned char *)0x52000204) // EP1 DMA Tx unit counter
#define EP1_DMA_FIFO                                                           \
  (*(volatile unsigned char *)0x52000208) // EP1 DMA Tx FIFO counter
#define EP1_DMA_TTC_L                                                          \
  (*(volatile unsigned char *)0x5200020c) // EP1 DMA total Tx counter
#define EP1_DMA_TTC_M (*(volatile unsigned char *)0x52000210)
#define EP1_DMA_TTC_H (*(volatile unsigned char *)0x52000214)
#define EP2_DMA_CON                                                            \
  (*(volatile unsigned char *)0x52000218) // EP2 DMA interface control
#define EP2_DMA_UNIT                                                           \
  (*(volatile unsigned char *)0x5200021c) // EP2 DMA Tx unit counter
#define EP2_DMA_FIFO                                                           \
  (*(volatile unsigned char *)0x52000220) // EP2 DMA Tx FIFO counter
#define EP2_DMA_TTC_L                                                          \
  (*(volatile unsigned char *)0x52000224) // EP2 DMA total Tx counter
#define EP2_DMA_TTC_M (*(volatile unsigned char *)0x52000228)
#define EP2_DMA_TTC_H (*(volatile unsigned char *)0x5200022c)
#define EP3_DMA_CON                                                            \
  (*(volatile unsigned char *)0x52000240) // EP3 DMA interface control
#define EP3_DMA_UNIT                                                           \
  (*(volatile unsigned char *)0x52000244) // EP3 DMA Tx unit counter
#define EP3_DMA_FIFO                                                           \
  (*(volatile unsigned char *)0x52000248) // EP3 DMA Tx FIFO counter
#define EP3_DMA_TTC_L                                                          \
  (*(volatile unsigned char *)0x5200024c) // EP3 DMA total Tx counter
#define EP3_DMA_TTC_M (*(volatile unsigned char *)0x52000250)
#define EP3_DMA_TTC_H (*(volatile unsigned char *)0x52000254)
#define EP4_DMA_CON                                                            \
  (*(volatile unsigned char *)0x52000258) // EP4 DMA interface control
#define EP4_DMA_UNIT                                                           \
  (*(volatile unsigned char *)0x5200025c) // EP4 DMA Tx unit counter
#define EP4_DMA_FIFO                                                           \
  (*(volatile unsigned char *)0x52000260) // EP4 DMA Tx FIFO counter
#define EP4_DMA_TTC_L                                                          \
  (*(volatile unsigned char *)0x52000264) // EP4 DMA total Tx counter
...
#define EXTINT0                                                                \
  (*(volatile unsigned *)0x56000088) // External interrupt control egister 0
#define EXTINT1                                                                \
  (*(volatile unsigned *)0x5600008c) // External interrupt control egister 1
#define EXTINT2                                                                \
  (*(volatile unsigned *)0x56000090) // External interrupt control egister 2
#define EINTFLT0 (*(volatile unsigned *)0x56000094) // Reserved
#define EINTFLT1 (*(volatile unsigned *)0x56000098) // Reserved
#define EINTFLT2                                                               \
  (*(volatile unsigned                                                         \
         *)0x5600009c) // External interrupt filter control egister 2
#define EINTFLT3                                                               \
  (*(volatile unsigned                                                         \
         *)0x560000a0) // External interrupt filter control egister 3
#define EINTMASK (*(volatile unsigned *)0x560000a4) // External interrupt mask
#define EINTPEND                                                               \
  (*(volatile unsigned *)0x560000a8)                // External interrupt
                                                    // pending
...
#define ALMDATE                                                                \
  (*(volatile unsigned char *)0x57000063) // Alarm day     <-- May 06, 2002 SOP
...
#define BCDDATE                                                                \
  (*(volatile unsigned char *)0x5700007f) // BCD day       <-- May 06, 2002 SOP
#define BCDDAY                                                                 \
  (*(volatile unsigned char *)0x57000083) // BCD date      <-- May 06, 2002 SOP
...
#define ALMDATE                                                                \
  (*(volatile unsigned char *)0x57000060) // Alarm day      <-- May 06, 2002 SOP
...
#define BCDDATE                                                                \
  (*(volatile unsigned char *)0x5700007c) // BCD day        <-- May 06, 2002 SOP
#define BCDDAY                                                                 \
  (*(volatile unsigned char *)0x57000080) // BCD date       <-- May 06, 2002 SOP
