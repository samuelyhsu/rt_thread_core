 ...
 * RT_Object_Class_Static 2010-10-26     yi.qiu       add module support in
 * rt_object_allocate and rt_object_free 2017-12-10     Bernard      Add
 * object_info enum. 2018-01-25     Bernard      Fix the object find issue when
 * enable MODULE. 2022-01-07     Gabriel      Moving __on_rt_xxxxx_hook to
 * object.c
 */
...
static struct rt_object_information _object_container[RT_Object_Info_Unknown] =
    {
        ...
        {RT_Object_Class_Memory,
         _OBJ_CONTAINER_LIST_INIT(RT_Object_Info_Memory),
        ...
        {RT_Object_Class_Custom,
         _OBJ_CONTAINER_LIST_INIT(RT_Object_Info_Custom),
         sizeof(struct rt_custom_object)},
#endif
};

#ifndef __on_rt_object_attach_hook
#define __on_rt_object_attach_hook(obj)                                        \
  __ON_HOOK_ARGS(rt_object_attach_hook, (obj))
#endif
#ifndef __on_rt_object_detach_hook
#define __on_rt_object_detach_hook(obj)                                        \
  __ON_HOOK_ARGS(rt_object_detach_hook, (obj))
#endif
 ...
 * object attaches to kernel object system.
 *
...
/**
 * @brief This function will set a hook function, which will be invoked when
 * object detaches from kernel object system.
 *
 * @param hook is the hook function
 */
...
/**
 * @brief This function will set a hook function, which will be invoked when
 * object is taken from kernel object system.
 *
...
/**
 * @brief This function will set a hook function, which will be invoked when
 * object have been taken from kernel object system.
 *
...
/**
 * @brief This function will set a hook function, which will be invoked when
 * object is put to kernel object system.
 *
 * @param hook is the hook function
 */
...
/**
 * @brief This function will return the length of object list in object
 * container.
 *
 * @param type is the type of object, which can be
 *             RT_Object_Class_Thread/Semaphore/Mutex... etc
...
int rt_object_get_length(enum rt_object_class_type type) {
  ...
  rt_list_for_each(node, &(information->object_list)) { count++; }
...
rt_object_t rt_custom_object_create(const char *name, void *data,
  ...
  cobj = (struct rt_custom_object *)rt_object_allocate(RT_Object_Class_Custom,
                                                       name);
  if (!cobj) {
    return RT_NULL;
  }
